...
from .properties import sii_gen as sii_gen_properties
from .operators import sii_gen as sii_gen_operators
from .ui import sii_gen as sii_gen_ui
...
def register():
    ...
    # --- AWAL PERUBAHAN ---
    # Impor modul baru di DALAM fungsi register agar pasti terdefinisi
    from .properties import sii_gen
    from .operators import sii_gen
    from .ui import sii_gen
    
    # Daftarkan modul sii_gen Anda secara manual dalam urutan yang benar
    sii_gen_properties.register()
    sii_gen_operators.register()
    sii_gen_ui.register()
    # --- AKHIR PERUBAHAN ---
...
def unregister():
    ...
    # --- AWAL PERUBAHAN ---
    # Impor modul baru di DALAM fungsi unregister juga
    from .properties import sii_gen
    from .operators import sii_gen
    from .ui import sii_gen

    # Hapus pendaftaran dalam urutan terbalik
    sii_gen_ui.unregister()
    sii_gen_operators.unregister()
    sii_gen_properties.unregister()
    # --- AKHIR PERUBAHAN ---
